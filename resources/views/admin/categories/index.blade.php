...
<div>
    ...
    <div class="flex space-x-2 justify-end p-3">
        <a href="{{ route('categories.create') }}"class="btn btn-primary p-3" >{{ __('Add Category') }}</a>
    ...
    <div class="overflow-x-scroll shadow-md">
        ...
        <tr>
            ...
            <th><a href="#" wire:click.prevent="sortBy('first_name')">{{ __('Category Name') }}</a></th>
            ...
            <tr>
                <div class="mr-8">
                    ...
                    <td>
                        ...
                        <div class="pl-8 pt-1 "><strong>{{$category->name }}</strong></div>
                    </td>
                </div>
               <td>
